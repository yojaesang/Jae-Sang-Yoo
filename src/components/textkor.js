...
export class TextKor extends Component {
  render() {
    return (
        <div className='m-10'>
            <div className='text-xs font-light font-grotesk'>KOR</div>
            <div className='text-base'>Sep 2023 - Present</div>

          <div className='my-4'></div>


      <div className='text-xl my-4 font-bold'>경험</div>
      ...
      <div className='ml-8'>
        ...
        <ul className='text-sm text-slate-400 list-disc'>
          ...
          <div className='font-bold'>B tv App for Apple tv UIUX</div>
          <li>Field User Research</li>
          <li>UX Redesign for Live tv</li>
          <li>Persionalized Contents Recommnedation UI</li>

          <div className='h-4 border-b'></div>
          <div className='font-bold'>B tv UX for Device</div>
          ...
          <div className='h-4 border-b'></div>
          <div className='font-bold'>UX Design System</div>
